...
void Application::start() {
    ...
    Log log = Log(controller.isTraceLevel(reader), controller.isInfoLevel(reader), controller.isErrorLevel(reader), controller.isFileLogger(reader), controller.isConsoleLogger(reader));
