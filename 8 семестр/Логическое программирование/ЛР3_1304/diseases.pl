...
disease('pishchevoye_otravleniye', ['toshnota', 'rvota', 'boli_v_zhivote', 'diareya']).
...
disease('gepatit', ['zheltyuka', 'boli_v_zhivote', 'ustalost', 'poterya_appetita']).
disease('infektsiya_pishchevaritelnogo_trakta', ['boli_v_zhivote', 'diareya', 'rvota', 'toshnota']).
